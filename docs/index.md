...
| 服务 | 端口 | 地址 | 功能 |
|------|------|------|------|
| **portfolio** | 8000 | http://192.168.31.100:8000 | 个人作品集展示网站 |
| **knowledge_graph** | 8002 | http://192.168.31.100:8002 | 知识图谱系统（D3.js可视化） |
| **agent_platform** | 8003 | http://192.168.31.100:8003 | 类Dify LLM应用平台 |
| **prompt_engineering** | 8004 | http://192.168.31.100:8004 | Prompt工程管理平台 |
...
| **[llm_agent_interview](https://github.com/dirjaker/llm_agent_interview)** | LLM & Agent 面试题全集（27专题/450+题/56000+行） | [在线访问](https://dirjaker.github.io/llm_agent_interview/) |
...
| **[knowledge_graph](https://github.com/dirjaker/knowledge_graph)** | 知识图谱系统：LLM实体/关系抽取、D3.js可视化、智能查询、图谱分析 | FastAPI + SQLite + D3.js + Vue3 | [仓库](https://github.com/dirjaker/knowledge_graph) |
...
| 项目 | 更新内容 |
|------|----------|
| **knowledge_graph** | 完整重构：LLM抽取、D3.js可视化、5套主题、5个页面 |
| **agent_platform** | 重构为类Dify平台：应用管理、知识库RAG、工作流编排、工具市场 |
| **prompt_engineering** | 重写Web前端：Vue3 SPA、5套主题、完整功能界面 |
| **portfolio** | 仪表盘优化、登录页毛玻璃、后台设置页、主题适配 |
| **vestio** | SPA中间件修复 |
| **yolo-trainer** | 数据库配置切换为SQLite |
